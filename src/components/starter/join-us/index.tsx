...
export default component$(() => {
  return (
    <div id={Anchor.JOIN_US} class="relative mb-61.5 max-lg:mb-37 w-full rounded-3xl flex flex-col items-center" style="background: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.1);">
      ...
      <div class="w-2/3 mx-auto mb-10 leading-6 select-none text-center tracking-wider" style="color: rgba(255, 255, 255, 0.56);">We're constantly searching for exceptional individuals who align with our principles and can aid us in advancing our objectives. Click the button below to learn more about us and view our open positions.</div>
